...
export default class LiveStreamComponent extends Component {
    ...
    renderMode(){
        if (this.state.pageState == 'loading'){
            ...
            return (
                <EmptyStateComponent
                    title = "LiveStream hasn't started yet"
                    description = "You will be notified when of new events"
                    icon  = "logo-youtube"
                    showButton = {false}
                />
            );
        ...
        return (
            <Container >
                <Header style={{backgroundColor:'#232642'}}>
                    ...
                    <Title style={{color:'white', fontFamily:'AvenirNext-Medium'}}>LIVE STREAM</Title>
                </Header>
                <Content
                    refreshControl={
                        <RefreshControl
