...
export default class VideoComponent extends Component {
    ...
    renderMode(){
        if (this.state.pageState == 'loading'){
            ...
            return (
                <EmptyStateComponent
                    title = "No Videos are available now"
                    description = "You will be notified when a new video pops up"
        ...
        return (
            <Container >
                <Header style={{backgroundColor:'#232642'}}>
                    ...
                    <Title style={{color:'white', fontFamily:'AvenirNext-Medium'}}>VIDEO</Title>
                </Header>
                <Content
                    refreshControl={
                        <RefreshControl
