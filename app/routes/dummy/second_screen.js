...
export default class SecondScreenComponent extends Component {
                    ...
                    <View style={{padding:25}}>
                        <View>
                            <View style={{flexDirection:'row', justifyContent:'space-between', marginBottom:10}}>
                                <Text style={{fontFamily: 'Avenir Next', color:'#16c1d5', fontSize:28, fontWeight:'bold'}}>GUNUNG MULU</Text>
                                <TouchableHighlight
                                    style={{padding:2,paddingRight:7,paddingLeft:7, borderWidth:1, borderColor:'grey', borderRadius:100}}
                                >
                                    <View>
                                        <Icon name='md-create' style={{color:'grey'}}/>
                                    </View>
                                </TouchableHighlight>
                            </View>
                            ...
                            <View style={{flexDirection:'row', justifyContent:'space-between', marginBottom:10,marginTop:10}}>
                                ...
                                <TouchableHighlight
                                    style={{padding:2,paddingRight:10,paddingLeft:10, borderWidth:1, borderColor:'#16c1d5', borderRadius:100}}
                                >
                                    <View>
                                        <Icon name='md-pin' style={{color:'#16c1d5'}}/>
                                    </View>
                                </TouchableHighlight>
                            </View>
                            <Hr lineColor='#ecf0f1' width="100"/>
                            <View style={{flexDirection:'row', justifyContent:'space-between', marginBottom:10,marginTop:10}}>
                                <Text style={{fontFamily: 'Avenir Next', color:'#c1c1c1', fontSize:23, marginTop:8}}>Mulu Marriot Resort</Text>
                                <TouchableHighlight
                                    style={{padding:2,paddingRight:10,paddingLeft:10, borderWidth:1, borderColor:'grey', borderRadius:100}}
                                >
                                    <View>
                                        <Icon name='md-pin' style={{color:'grey'}}/>
                                    </View>
                                </TouchableHighlight>
                            </View>
                            <Hr lineColor='#ecf0f1' width="100"/>
                            <View style={{flexDirection:'row', justifyContent:'space-between', marginBottom:10,marginTop:10}}>
                                <Text style={{fontFamily: 'Avenir Next', color:'#c1c1c1', fontSize:23, marginTop:8}}>Sungai River</Text>
                                <TouchableHighlight
                                    style={{padding:2,paddingRight:10,paddingLeft:10, borderWidth:1, borderColor:'grey', borderRadius:100}}
                                >
                                    <View>
