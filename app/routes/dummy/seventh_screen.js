...
export default class SeventhScreenComponent extends Component {
            ...
            <View style={{flex:1, backgroundColor:'#006376'}}>
                <LinearGradient colors={['#7cffe0', '#004558']}>
                    <View style={{padding:15}}>
                        <View style={{height:height*0.47, padding:width*0.02, alignItems:'center' , justifyContent:'center', marginTop:height*0.0001}}>
                            <Image source={require('../../images/birdicon.png')} style={{height:100, width:100, borderWidth:4, borderRadius:4}} />
                            <Image source={require('../../images/birdicon_other.png')} resizeMode='contain' style={{marginTop:height*0.01,height:height*0.2, width:width*0.9}} />
                        </View>
                        <View style={{height:height*0.5, padding:width*0.02, marginTop:-height*0.07}}>
                            <View style={{backgroundColor:'#f5f5f5', height:50, borderRadius:10, marginTop:height*0.015}}>
                            ...
                            <View>
                                <TouchableHighlight style={{backgroundColor:'#16c1d5', padding:12, borderRadius:5, marginTop:height*0.02, alignItems:'center'}}>
                                    <Text style={{fontFamily: 'Avenir Next', color:'white', fontSize:20}}>LOGIN</Text>
                                </TouchableHighlight>
                            </View>
                            <View style={{alignItems:'center', flexDirection:'row', marginTop:height*0.02, justifyContent:'space-around'}}>
                                <Text style={{fontFamily: 'Avenir Next', color:'white', backgroundColor:'transparent'}}>Ainda nao tem uma conta? </Text>
                                <Text style={{fontFamily: 'Avenir Next', color:'white', fontWeight:'bold', backgroundColor:'transparent'}}>Cadastre-se? </Text>
                            </View>
                            <View>
                                <TouchableHighlight
                                ...
                                requestAnimationFrame(() => {
                                    ...
                                    style={{backgroundColor:'#0074b6', padding:12, borderRadius:5, marginTop:height*0.02, alignItems:'center'}}>
                                    <View style={{flexDirection:'row'}}>
                                        <Text style={{fontFamily: 'Avenir Next', color:'white', fontSize:20}}>Fazar login utilanzando</Text>
                                        <Text style={{fontFamily: 'Avenir Next', color:'white', fontSize:20, fontWeight:'bold'}}> Facebook</Text>
                                    </View>
                                </TouchableHighlight>
                            </View>
                            <View style={{alignItems:'center', flexDirection:'row', marginTop:height*0.03}}>
